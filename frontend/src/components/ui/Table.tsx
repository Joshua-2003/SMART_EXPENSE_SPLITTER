...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn('bg-slate-50 border-b border-slate-200 text-slate-500 font-medium', className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn('h-9 px-4 text-left align-middle font-medium text-slate-600 uppercase tracking-wider text-[11px]', className)}
    {...props}
  />
));
